...
from services.history import History, Total
...
api.add_resource(History, '/history/<string:uuid>',endpoint="history")
api.add_resource(Total, '/history/total/<string:uuid>',endpoint="total")
